...
export function AppStoreLink({ color = 'black' }) {
  ...
  function CircleBackground({ color, ...props }) {
    let id = useId()
    return (
        <svg
          viewBox="0 0 558 558"
    ...
    export function CallToAction() {
      return (
              <div className="relative  bg-[radial-gradient(#2C313D_35%,#000)] rounded-4xl mt-24 sm:mt-32 lg:mt-40">
                      ...
                      <div className="relative">
                          ...
                          <div className="z-10 mx-auto max-w-md text-center">
                              ...
                              <p className="mt-4 text-lg text-gray-300">
                                  Unlock a world of adventure. Subscribe today to start creating epic stories and iconic characters.       
                              </p>           
                              <div className="mt-8 flex justify-center">
                                  <div className="lg:mt-6 sm:mt-8 flex justify-center">
