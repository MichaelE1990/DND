    ...
    return (
        ...
        >
            ...
            <SectionIntro
                ...
                title="Embark on Your Journey with Our Essential Tools"
                className="mt-24 font-display sm:mt-32 lg:mt-10"
            >
                <p>
                    Prepare for your next quest with features designed for dungeon masters and adventurers alike. Navigate through epic tales and legendary encounters with ease.
                </p>
            </SectionIntro>
                ...
                >
                    {videos.map((video) => (
                        <li key={video.title} className="[counter-increment:video]">
                            ...
                            >
                                <div className="flex overflow-hidden rounded shadow-xl">
                                    <Image src={video.image} alt="" unoptimized />
                                </div>
                                <div className="absolute bottom-2 left-2 flex items-center rounded-lg bg-black/30 px-1.5 py-0.5 text-xs font-light text-white [@supports(backdrop-filter:blur(0))]:bg-white/10 [@supports(backdrop-filter:blur(0))]:backdrop-blur">
                            ...
                            <h3 className="mt-8 text-md tracking-tight text-slate-900 before:mb-2 before:block before:font-mono before:text-sm before:text-slate-500 before:content-[counter(video,decimal-leading-zero)]">
                                {video.title}
                            </h3>
